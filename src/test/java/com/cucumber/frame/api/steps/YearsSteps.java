...
import com.cucumber.frame.api.pojos.Color;
...
public class YearsSteps {
    ...
    public void getListOfYears() {
        colors = given()
                ...
                .extract().body().jsonPath().getList("data", Color.class);
    }
    ...
    public void the_response_must_contain_a_list_of_years_sorted_in_ascending_order() {
        List<Integer> years = colors.stream().map(Color::getYear).collect(Collectors.toList());
